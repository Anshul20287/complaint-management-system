...
/**
 * Hero — full-viewport landing section with headline, CTA buttons,
 * stats row and the animated live-map card.
 */
      ...
      <div className="max-w-[1180px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
        ...
        <div>
          ...
          <div ref={r4} className="animate flex gap-3.5 flex-wrap mb-12">
            <button className="px-8 py-3.5 text-[0.95rem] rounded-xl font-semibold bg-accent text-bg border-none cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,245,212,0.3)]">
              Report an Issue →
            </button>
            <button
